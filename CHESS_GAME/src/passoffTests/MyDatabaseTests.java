...
import main.Services.ClearApplicationService;
...
public class MyDatabaseTests {
    ...
    @BeforeEach
    public void setup() throws main.dataAccess.DataAccessException, DataAccessException {
    ...
    @Order(1)
    public void createGameP() throws DataAccessException, main.dataAccess.DataAccessException {
    ...
    @Order(3)
    public void updateGameP() throws DataAccessException, main.dataAccess.DataAccessException {
        Game game = createTestGame();
    ...
    @Order(5)
    public void readGameP() throws DataAccessException, main.dataAccess.DataAccessException {
        Game game = createTestGame();
    ...
    @Order(6)
    public void readGameN() throws DataAccessException, main.dataAccess.DataAccessException {
        Game game = createTestGame();
    ...
    @Order(7)
    public void deleteGameP() throws DataAccessException, main.dataAccess.DataAccessException {
        Game game = createTestGame();
    ...
    @Order(8)
    public void deleteGameN() throws DataAccessException, main.dataAccess.DataAccessException {
        Game game = createTestGame();
    ...
    @Order(9)
    public void insertGameP() throws DataAccessException, main.dataAccess.DataAccessException {
        Game game = createTestGame();
    ...
    @Order(10)
    public void FindAllP() throws DataAccessException, main.dataAccess.DataAccessException {
        Game game = createTestGame();
    ...
    @Order(11)
    public void FindAllN() throws DataAccessException, main.dataAccess.DataAccessException {
        Game game = createTestGame();
    ...
    @Order(12)
    public void claimSpotP() throws DataAccessException, main.dataAccess.DataAccessException {
        Game game = createTestGame();
        gameDAO.insertGame(game, THE_DATABASE);
    ...
    @Order(16)
    public void readUserP() throws DataAccessException, main.dataAccess.DataAccessException {
    ...
    @Order(17)
    public void readUserN() throws DataAccessException, main.dataAccess.DataAccessException {
        Assertions.assertThrows(NullPointerException.class, () -> {
    ...
    @Order(24)
    public void readAuthP() throws DataAccessException, main.dataAccess.DataAccessException {
    ...
    @Order(25)
    public void readAuthN() throws DataAccessException, main.dataAccess.DataAccessException {
        AuthTokenRequest authTokenRequest = new AuthTokenRequest();
        authTokenRequest.setAuthToken(existingAuth);
        authTokenRequest.setUsername(existingUser.getUsername());
    ...
    @Order(27)
    public void updateAuthN() throws DataAccessException, main.dataAccess.DataAccessException {
        Assertions.assertThrows(NullPointerException.class, () -> {
    ...
    @Order(30)
    public void getUsernameP() throws DataAccessException, main.dataAccess.DataAccessException {
        Assertions.assertDoesNotThrow(() -> {
    ...
    @Order(31)
    public void getUsernameN() throws DataAccessException, main.dataAccess.DataAccessException {
        Assertions.assertThrows(NullPointerException.class, () -> {
    ...
    @Order(32)
    public void getAuthTokenP() throws DataAccessException, main.dataAccess.DataAccessException {
        Assertions.assertDoesNotThrow(() -> {
    ...
    @Order(33)
    public void getAuthTokenN() throws DataAccessException, main.dataAccess.DataAccessException {
        Assertions.assertThrows(NullPointerException.class, () -> {
    ...
    @Order(34)
    public void getDatabaseTokensP() throws DataAccessException, main.dataAccess.DataAccessException {
    ...
    @Order(36)
    public void clearDatabase() throws DataAccessException, main.dataAccess.DataAccessException {
        Assertions.assertDoesNotThrow(() -> {
            ClearApplicationService clearApplicationService = new ClearApplicationService();
            clearApplicationService.clearApplication(authDAO, gameDAO, userDAO, THE_DATABASE);
        });
