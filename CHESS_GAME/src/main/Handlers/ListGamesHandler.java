...
public class ListGamesHandler extends BaseChecker {
     ...
     */
    public String authTokenTolistGamesHTTP (AuthTokenRequest request, String errorMessage, AuthDAO authDatabase, GameDAO gameDatabase, Database db) throws main.dataAccess.DataAccessException {
        Gson gson = new Gson();
